...
class UIButtonX: UIButton {
   ...
   //    MARK: - Gradient
    ...
    @IBInspectable var isPrimaryBackground:Bool = false {
        didSet {
            updateView()
        }
    }
    @IBInspectable var isPrimaryTitle:Bool = false {
        didSet {
            updateView()
        }
    }
    ...
    func updateView() {
        ...
        if isPrimaryBackground {
            self.backgroundColor = UIColor.primary_color
        }
        if isPrimaryTitle {
            self.setTitleColor(UIColor.primary_color, for: .normal)
        }
